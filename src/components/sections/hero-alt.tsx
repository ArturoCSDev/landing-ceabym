  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center pt-16">
      ...
      <div className="absolute inset-0 z-[-1]">
        <div className="w-full h-full bg-secondary-3 dark:bg-secondary-2 flex items-center justify-center overflow-hidden">
          ...
          <div className="relative w-full h-full opacity-40 dark:opacity-20">
            {/* Abstract hexagonal/molecular pattern background */}
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              <defs>
                <pattern id="hexagons" width="16" height="28" patternUnits="userSpaceOnUse" patternTransform="scale(0.8) rotate(0)">
                  <g stroke="currentColor" strokeWidth="0.4" fill="none" className="text-ceabym-8/30">
                    <path d="M8 0 L0 4.8 L0 14.4 L8 19.2 L16 14.4 L16 4.8 L8 0 Z" />
                    <path d="M8 28 L0 23.2 L0 13.6 L8 8.8 L16 13.6 L16 23.2 L8 28 Z" />
                    <path d="M16 14.4 L24 19.2 L32 14.4 L32 4.8 L24 0 L16 4.8 Z" />
                  </g>
                </pattern>
              </defs>
            ...
            <div className="absolute top-2/3 right-1/3 w-1/4 h-1/4 rounded-full bg-ceabym-7/15 dark:bg-ceabym-8/15 blur-2xl"></div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute top-1/4 left-1/5 w-10 h-10 rounded-full bg-ceabym-4/30 dark:bg-ceabym-5/20 animate-pulse duration-[4s] z-0"></div>
      <div className="absolute bottom-1/3 right-1/4 w-8 h-8 rounded-full bg-ceabym-5/30 dark:bg-ceabym-6/20 animate-pulse duration-[5s] z-0"></div>
